...
export default function dashboard() {
    ...
    const [fileContent, setFileContet] = useState();
                    ...
                    <div className={styles.scrollComponent}>
                        ...
                        <div className={styles.wrapper}>
                            ...
                            <div className={styles.createPostContainer}>
                                <img className={styles.userProfile} src={`${BASE_URL}/${authState.user?.userId?.profilePicture || "default.jpg"}`} alt="profile" />
                                ...
                                <input onChange={(e) => setFileContet(e.target.files[0])} type="file" hidden id='fileUpload' />
                                {postContent.length > 0 && <div onClick={handleUpload} className={styles.uploadBtn}>Post</div>}
                                    ...
                                    return (
                                        <div key={post._id} className={styles.singleCard}>
                                            ...
                                            <div className={styles.singleCard_profileContainer}>
                                                <img className={styles.userProfile} src={`${BASE_URL}/${authState.user?.userId?.profilePicture || "default.jpg"}`} alt="" />
                                                <div>
                                                    <div style={{ display: "flex", justifyContent: "space-between" }}>
                                                        <p style={{ fontWeight: "bold" }}>{post.userId.name}</p>
                                                        {
                                                            ...
                                                            <div onClick={async () => {
                                                                ...
                                                                <svg style={{ height: "1.2rem", color: "red", marginTop: "0.5rem" }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                                                    ...
                                                    <div className={styles.single__cardImage}>
                        ...
                        <div onClick={() => {
                            ...
                            <div onClick={(e) => {
                                ...
                                <div className={styles.postCommentContainer}>
                                    <input onChange={(e) => setCommentText(e.target.value)} value={commentText} type="text" placeholder='Comment' name="" id="" />
                                    <div onClick={async () => {
